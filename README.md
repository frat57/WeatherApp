...
## Push edildi
Bu repodaki değişiklikler `main` branch'e pushlandı.

---
Eğer isterseniz README'ye daha fazla bölüm (örn. örnek ekran görüntüleri, katkı rehberi, lisans) ekleyebilirim — nasıl devam etmemi istersiniz? 
# WeatherApp
Weather Application
